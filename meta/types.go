...
// Deprecated: TypeId is a reference to an underlying type.
type TypeId int
...
type Named struct {
	...
	Underlying Qualifier

	// Methods contains the declared methods for this named type.
	Methods []Qualifier
}
